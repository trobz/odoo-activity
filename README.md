...
packaged scripts (`create_test_job`, `restore_app_icons`), the same actions
the TUI's `oa --enable-odooly` offers a human through the Toolbox — now
callable by the agent directly.
